        ...
        <>
            <nav className="bg-[#b7d8d2]/80 backdrop-blur-lg w-full sticky top-0 z-20 shadow-sm">
                <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-4 h-16">
                    ...
                    <div className="hidden md:flex gap-6 md:gap-10">
                        <Link to="/home#home" className="font-inter font-medium text-teal-900 hover:scale-110 transition-transform">Home</Link>
                        <Link to="/home#products" className="font-inter font-medium text-teal-900 hover:scale-110 transition-transform">Products</Link>
                        <Link to="/home#about" className="font-inter font-medium text-teal-900 hover:scale-110 transition-transform">About</Link>
            ...
            <div className={`fixed top-0 right-0 h-full w-64 bg-[#b7d8d2] shadow-lg z-40 transform transition-transform duration-300 ${ menuOpen ? 'translate-x-0' : 'translate-x-full' }`}>
                ...
                <div className="flex flex-col items-start gap-6 px-6 mt-8">
                    <Link onClick={() => setMenuOpen(false)} to="/home#home" className="text-teal-900 font-inter text-lg">Home</Link>
                    <Link onClick={() => setMenuOpen(false)} to="/home#products" className="text-teal-900 font-inter text-lg">Products</Link>
                    <Link onClick={() => setMenuOpen(false)} to="/home#about" className="text-teal-900 font-inter text-lg">About</Link>
